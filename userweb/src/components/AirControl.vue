<template>
  <div>
    <div>
      <!--      制冷模式-->
      <i class="bi bi-snow2 mr-5 btn" @click="coldm">
        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-snow2 rounded-circle cold" viewBox="-7 -7 30 30">
      ...
      <!--      暖气模式-->
      <i class="bi bi-sun ml-5 btn" @click="warmm">
        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-sun rounded-circle warm" viewBox="-7 -7 30 30">
    ...
    <div>
      <!--      温度上调-->
      <i class="bi bi-arrow-up-circle mr-5 btn" @click="add">
      ...
      <!--      风速上调-->
      <i class="bi bi-arrow-up-circle-fill ml-5 btn" @click="addw">
    ...
    <div>
      <!--      温度图标-->
      <i class="bi bi-thermometer mr-4">
        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-thermometer" viewBox="0 0 16 16">
          <path d="M8 14a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z"/>
          <path d="M8 0a2.5 2.5 0 0 0-2.5 2.5v7.55a3.5 3.5 0 1 0 5 0V2.5A2.5 2.5 0 0 0 8 0zM6.5 2.5a1.5 1.5 0 1 1 3 0v7.987l.167.15a2.5 2.5 0 1 1-3.333 0l.166-.15V2.5z"/>
        </svg>
      </i>
      <!--      开关图标-->
      <i class="bi bi-power mr-2 ml-2 btn" @click="changeswitch">
...
<!--      风速-->
    ...
    <div>
      <!--      温度下调-->
      <i class="bi bi-arrow-down-circle mr-5 btn" @click="reduce">
        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-arrow-down-circle" viewBox="0 0 16 16">
          <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8zm15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8.5 4.5a.5.5 0 0 0-1 0v5.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V4.5z"/>
        </svg>
      </i>
      <!--      风速下调-->
      <i class="bi bi-arrow-down-circle-fill ml-5 btn" @click="reducew">
